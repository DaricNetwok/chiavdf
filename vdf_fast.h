...
struct square_state_type {
    ...
    int get_counter_start(int phase) {
        int res[] = {counter_start_phase_0, counter_start_phase_1, counter_start_phase_2, counter_start_phase_3,
...
void repeated_square_fast_work(square_state_type &square_state, bool is_slave, uint64 base, uint64 iterations,
...
uint64 repeated_square_fast_multithread(square_state_type &square_state, form &f, const integer &D, const integer &L,
    ...
    thread slave_thread(repeated_square_fast_work, std::ref(square_state), false, base, iterations,
                        std::ref(nuduplListener));
...
uint64 repeated_square_fast_single_thread(square_state_type &square_state, form &f, const integer &D, const integer &L,
                                          uint64 base, uint64 iterations, INUDUPLListener *nuduplListener) {
    master_counter[square_state.pairindex].reset();
    slave_counter[square_state.pairindex].reset();
...
uint64 repeated_square_fast(square_state_type &square_state, form &f, const integer &D, const integer &L, uint64 base,
                            uint64 iterations, INUDUPLListener *nuduplListener) {
